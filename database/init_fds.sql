...
CREATE TABLE WorkShift (
	...
	all_work_hours	INTEGER NOT NULL,
...
CREATE TABLE Rider (
	empid		INTEGER PRIMARY KEY REFERENCES FDSEmployee,
	emptype     emp_type NOT NULL,
	isPartTime	BOOLEAN NOT NULL,
	wid			INTEGER NOT NULL, 
	--FOREIGN KEY (empid, emptype) REFERENCES FDSEmployee (empid, emptype) ON DELETE CASCADE,
