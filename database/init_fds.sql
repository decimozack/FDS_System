...
CREATE TABLE WorkShift (
	...
	hour_1st		INTEGER, -- 0-1
	hour_2nd		INTEGER, -- 1-2
	hour_3rd		INTEGER, -- 2-3
	hour_4th		INTEGER, -- 3-4
	hour_5th		INTEGER, -- 4-5
	hour_6th		INTEGER, -- 5-6
	hour_7th		INTEGER, -- 6-7
	hour_8th		INTEGER, -- 7-8
	hour_9th		INTEGER, -- 8-9
	hour_10th		INTEGER, -- 9-10
	hour_11th		INTEGER, -- 10-11
	hour_12th		INTEGER, -- 11-12
...
CREATE TRIGGER assign_order_trigger
	...
	ON OrderWaitingList
	FOR EACH ROW
	EXECUTE FUNCTION assign_order();LE IF EXISTS Manager CASCADE;
DROP TYPE IF EXISTS ostatus CASCADE;
DROP TYPE IF EXISTS emp_type CASCADE;
